...
DROP POLICY IF EXISTS comm_audit_firm_staff_read ON communication_audit_log;
...
DROP POLICY IF EXISTS comm_audit_super_admin_read ON communication_audit_log;
